...
<body>
    <div class="smallBox"> <!--Formular pro zadání nového zápisu do tabulky Locations-->
        <form action="../includes/locationformhandler.inc.php" method="post" autocomplete="off">
            ...
            <br>
            <input type="text" id="LCS" name="LCS" placeholder="LCS" title="1-255">
            <br>
            <input type="text" id="FCS" name="FCS" placeholder="FCS" title="1..0xFFFF">
            <br>
            <input type="text" id="locationClass" name="locationClass" placeholder="Typ lokace" title="1-65535">
            <br>
            <input type="text" id="locationPosi" name="locationPosi" placeholder="Pozice" title="1-65535">
            <br><br>
