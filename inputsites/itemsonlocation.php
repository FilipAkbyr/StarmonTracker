...
<body>
    <div class="smallBox"> <!--Tabulka pro zadání požadovaného LocationID-->
        <form action="itemsonlocation.php" method="post" autocomplete="off">
            ...
            <p id="itemCounter">Celkem prvků v lokaci:</p><br>
    ...
    <div class="smallBox"> <!--Tabulka pro vypsání History-->
        <table rules="all">
            ...
            $onlyCurrent = isset($_POST["onlyCurrent"]) ? $_POST["onlyCurrent"] : null;

            if ($_SERVER["REQUEST_METHOD"] == "POST" && is_numeric($locationID) && $locationID >= 0) {
                try {
